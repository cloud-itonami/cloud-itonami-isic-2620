# Operator Quickstart — Manufacture of Computers and Peripheral Equipment

Shortest path from clone to a verified local dry-run for **ISIC 2620** (`cloud-itonami-isic-2620`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2620.git
cd cloud-itonami-isic-2620
```
...
- Blueprint governor key: `assembly-governor`
- Likely source path: `deviceassembly.governor.cljc`
